...
#ifndef BEAMLET_SWIFT_H
#define BEAMLET_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Beamlet",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
@class NSData;
SWIFT_CLASS("_TtC7Beamlet11AppDelegate")
...
SWIFT_CLASS("_TtC7Beamlet13NearbyService")
...
@class CBService;
@interface NearbyService (SWIFT_EXTENSION(Beamlet)) <CBPeripheralManagerDelegate>
...
@class NSNumber;
@interface NearbyService (SWIFT_EXTENSION(Beamlet)) <CBPeripheralDelegate>
...
@class NSString;
@interface NearbyService (SWIFT_EXTENSION(Beamlet)) <CBCentralManagerDelegate>
...
@class NSBundle;
@class NSCoder;
SWIFT_CLASS("_TtC7Beamlet21ScannerViewController")
